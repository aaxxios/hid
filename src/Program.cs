...
builder.Services.AddScoped<GoogleCodeReceiver>();
//builder.WebHost.UseUrls("http://199.102.48.6:8443");
builder.Services.AddSingleton<GoogleFlow>();
...
//builder.Services.AddHttpClient<UpdateHandlers>();
...
#pragma warning restore CA1050 // Declare types in namespaces
{
    ...
    public string GoogleRedirecUrl { get; init; } = default!;

    public string GoogleClientSeceret { get; init; } = default!;
