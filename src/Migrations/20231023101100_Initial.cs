    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Googles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Googles_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Docs_OwnerId",
                table: "Docs",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Googles_OwnerId",
                table: "Googles",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Panels_OwnerId",
                table: "Panels",
                column: "OwnerId");
        }
